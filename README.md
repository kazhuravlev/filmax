...
**Кинотеатр для телефона и Android TV в одном APK.** Неофициальный клиент kino.watch:
...
| ![Каталог](docs/screenshots/tv-catalog.png) | ![Личные разделы](docs/screenshots/tv-library.png) |
| *Каталог: типы, жанры, сортировка, фильтры* | *«Я смотрю»: продолжить и история; «Закладки»: отложенное и папки* |
...
- **«Я смотрю»:** продолжение и история.
- **«Закладки»:** «Буду смотреть» (серверный watchlist + локальный кэш) и папки-закладки.
...
3. Войдите по коду (OAuth2 device-flow) с аккаунтом kino.watch.
...
И на телефоне, и на ТВ — четыре раздела: **Главная · Я смотрю · Каталог · Закладки**, плюс
...
*Filmax — некоммерческий проект для личного использования. Требуется аккаунт kino.watch.*
