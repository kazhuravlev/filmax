...
object FilmaxMetrics {
    ...
    /**
     * Нижнее поле вертикальной ленты — воздух между последним рядом и таб-баром.
     * Без него лента упирается в панель навигации: последняя карточка выглядит обрезанной.
     */
