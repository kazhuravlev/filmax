...
/**
 * Актёрский состав с фотографиями. У kino.watch людей нет вовсе — `cast` приходит строкой имён,
 ...
 * возвращает пустой список — деталям тогда достаточно строки имён от kino.watch.
 */
