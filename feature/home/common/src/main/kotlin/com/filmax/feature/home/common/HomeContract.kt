 ...
 * [HomeScreenModel.onFetchData]: все источники стартуют параллельно и красят своё состояние по
 * готовности, не дожидаясь друг друга. Экран (`TvHomeScreen.tvRails`) на этот флаг не смотрит:
 * скелетон рисуется, только если в ряду вообще нет карточек — если есть затравка из кэша или
 * прошлый успешный ответ, они остаются на экране, пока их не сменит свежий результат, без
 * мигания скелетоном поверх уже видимого контента на каждом рефетче.
 */
